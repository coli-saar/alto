...
See the [Wiki](https://bitbucket.org/tclup/alto/wiki/Home) for more details on how to use Alto. The [tutorials](https://bitbucket.org/tclup/alto/wiki/Tutorials) are a good way to get started with Alto. You can also check out the [Apidocs](http://www.ling.uni-potsdam.de/tcl/alto/apidocs/).
