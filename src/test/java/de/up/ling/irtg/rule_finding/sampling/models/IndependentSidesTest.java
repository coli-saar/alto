...
public class IndependentSidesTest {
     ...
     * 
     */
    private IntPredicate ipL;
    
    /**
     * 
     */
    private IntPredicate ipR;
    
    /**
     * 
     */
    private Function<Tree<Rule>,Tree<Integer>> lMap;
    
    /**
     * 
     */
    private Function<Tree<Rule>,Tree<Integer>> rMap;
    ...
    public void setUp() throws Exception {
        ...
        Homomorphism homL = homm.getHomomorphism1();
        this.ipL = IndependentSides.makeIntPredictate(homL.getTargetSignature());
        this.lMap = IndependentSides.createDecoder(homL);
        
        Homomorphism homR = homm.getHomomorphism2();
        this.ipR = IndependentSides.makeIntPredictate(homR.getTargetSignature());
        this.rMap = IndependentSides.createDecoder(homR);
        ...
        this.ins = 
                new IndependentSides(homL.getTargetSignature(), homR.getTargetSignature(),
                        ipL, ipR, 1.0, lMap, rMap);
        
        
        com.google.common.base.Function<Integer,String> f1 = (Integer i ) -> homL.getTargetSignature().resolveSymbolId(i);
        com.google.common.base.Function<Integer,String> f2 = (Integer i ) -> homR.getTargetSignature().resolveSymbolId(i);
    }
    ...
    public void testGetLogWeight() {
        ...
        d1 = this.ins.getLogWeight(imp1);
        d2 = this.ins.getLogWeight(imp2);
        
        assertEquals(d1,d2,0.00001);
        assertEquals(d1,-58.88877958332882,0.00001);
        
        this.ins.add(this.imp1, 20.0);
        
        double d3;
        double d4;
        System.out.println(d3 = this.ins.getLogWeight(imp1));
        System.out.println(d4 = this.ins.getLogWeight(imp2));
        
        assertEquals(d3,-11.173966314398093,0.000001);
        assertEquals(d4,-70.27317532020153,0.000001);
        ...
        assertEquals(d1,this.ins.getLogWeight(imp1),0.00001);
        assertEquals(this.ins.getLogWeight(imp2),this.ins.getLogWeight(imp1),0.00001);
    }
}
