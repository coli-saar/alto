...
public class PtbTreeInputCodec extends InputCodec<Tree<String>> {
     ...
     */
    @Override
    public Tree<String> read(InputStream is) throws ParseException, IOException {
     ...
     * @throws IOException 
     */
    public List<Tree<String>> readCorpus(InputStream is) throws ParseException, IOException {
        PtbTreeLexer l = new PtbTreeLexer(new ANTLRInputStream(is));
        PtbTreeParser p = new PtbTreeParser(new CommonTokenStream(l));
        p.setErrorHandler(new ExceptionErrorStrategy());
        p.getInterpreter().setPredictionMode(PredictionMode.SLL);
...
//    
////    @Override
//    public Tree rread(InputStream is) throws ParseException, IOException {
