scala -J-server -cp ../scala-irtg-shell/target/scala-2.9.1.final/scala-irtg-shell_2.9.1-1.0.jar:target/irtg-1.0-SNAPSHOT-jar-with-dependencies.jar  -Yrepl-sync -i ../scala-irtg-shell/init.scala 
